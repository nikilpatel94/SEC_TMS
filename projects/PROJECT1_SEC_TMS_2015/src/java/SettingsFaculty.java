 ...
 * @author nikil
 */
public class SettingsFaculty extends HttpServlet {
...
MultipartRequest mpr=new MultipartRequest(request,"F:/project/SEC/mid sem/PROJECT1_SEC_TMS_2015/web/FileUpload/FacultyPhotos",1024*1024*10);        
        try {
