...
if(request.getParameter("btnProceed")!=null)
    {
        ...
        buildtable=genobj.filltbl("select StudentId,Std,StudentName,StudentContactNo,StudentEmail,StudentParentName,StudentParentContactNo from studentmaster where "+drpsearch+" LIKE '%"+searchvalue+"%'", 8, "StudentMaster");
        }
    else if(request.getParameter("btnProceed").equals("View All"))
        {
         buildtable=genobj.filltbl("select StudentId,Std,StudentName,StudentContactNo,StudentEmail,StudentParentName,StudentParentContactNo from studentmaster",8 , "StudentMaster");
        }
    else
            {
         buildtable=genobj.filltbl("select StudentId,Std,StudentName,StudentContactNo,StudentEmail,StudentParentName,StudentParentContactNo from studentmaster",8 , "StudentMaster");
...
else
    {
     buildtable=genobj.filltbl("select StudentId,Std,StudentName,StudentContactNo,StudentEmail,StudentParentName,StudentParentContactNo from studentmaster",8 , "StudentMaster");
        ...
        %>
        <form action="DisplayStudent.jsp" class="panel form-horizontal">
