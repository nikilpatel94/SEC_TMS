...
<html>
  ...
  <strong>Error!</strong> <% ex.printStackTrace(); %> !!!.
        ...
        <form action="../ViewProfile" class="panel form-horizontal">
        <input type="hidden" name="FacultyId" value="<%=fid%>" />
            
            <div class="panel-heading">
                <span class="panel-title"><h4><strong>Student Profile</strong></h4></span>
            </div>
          ...
          <div class="row">
                    ...
                    <script>
                        function dirtxt30()
                        {
                            ...
                            url = "AJAXFetchViewPorfileSubjectDetail.jsp";
            ...
            <div class="row">
                ...
                <label class="control-label"align="left" >Student Name</label>
                </div>
                <table class="table table-bordered table-hover">
                    <thead>
                        ...
                        function dirtxt3()
                        {
                            ...
                            var str=str1.options[str1.selectedIndex].value;
                            url = "AJAXFetchViewPorfileStudentName.jsp";
                            url = url + "?reqid="+str;                         
