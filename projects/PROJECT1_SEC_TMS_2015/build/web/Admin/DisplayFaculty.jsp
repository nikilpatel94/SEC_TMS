...
if(request.getParameter("btnProceed")!=null)
    {
        ...
        buildtable=genobj.filltbl("select FacultyId,FacultyName,FacultyContactNo,FacultyEmail,Salary from facultymaster where "+drpsearch+" LIKE '%"+searchvalue+"%'", 6, "FacultyMaster");
        }
    else if(request.getParameter("btnProceed").equals("View All"))
        {
         buildtable=genobj.filltbl("select FacultyId,FacultyName,FacultyContactNo,FacultyEmail,Salary from facultymaster",6 , "FacultyMaster");
        }
    else
            {
         buildtable=genobj.filltbl("select FacultyId,FacultyName,FacultyContactNo,FacultyEmail,Salary from facultymaster",6 , "FacultyMaster");
...
else
    {
     buildtable=genobj.filltbl("select FacultyId,FacultyName,FacultyContactNo,FacultyEmail,Salary from facultymaster",6 , "FacultyMaster");
        ...
        %>
        <form action="DisplayFaculty.jsp" class="panel form-horizontal">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <a href="FacultyMaster.jsp?reqid=0" > <strong>Add New Faculty</strong></a>
