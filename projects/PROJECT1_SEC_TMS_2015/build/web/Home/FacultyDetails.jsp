    ...
    <body>
      ...
      if(request.getParameter("fid")!=null)
            ...
            List<Object[]> rs1=null;
                    rs1=conobj.FetchData("SELECT * FROM facultymaster where FacultyId='"+request.getParameter("fid").toString() +"'");
        ...
        <div class="col-md-8">
            <section>
                <div class="panel panel-primary">
                    <div class="panel-heading"><i class="fa fa-user"></i> General Information of <%=fname%></div>
